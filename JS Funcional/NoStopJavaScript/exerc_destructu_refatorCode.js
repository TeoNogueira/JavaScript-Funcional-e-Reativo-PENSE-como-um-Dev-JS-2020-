...
let { estacionamentoQtVagas } = carros
...
//events:
   ...
   if( forbiddenCars ) {
    ...
    return getAvailableSpacesMessage(estacionamentoQtVagas, entradaDeVagas)
...
console.log(carros.addVagas(9))
console.log(carros.addVagas(6))
console.log(carros.addVagas(6))
console.log(carros)